                ...
                <div class="test-drive-modal-body">
                    ...
                    <div class="fs-container testdrive">
                        ...
                        <div class="step-1 d-none active">
                            ...
                            <div class="group group-selected-time">
                                <select class="form-control selected-time selected_time_s form-input" disabled title="Selected time" name="selected_time_s" id="slider-selected-time">
                                    <option></option>
                                </select>
                                <label for="selected-time">Selected time</label>
                                <span class="input-error-req"></span>
                            </div>
                        </div>
                        <div class="step-2">
                            <div class="Cu-one">
                        ...
                        <div class="Cu-one">
                            <div class="group">
                                <input type="Tel" id="phone-slide-vdp-test-drive" title="Phone Number" placeholder=" " name="phone" class="phone form-input" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
