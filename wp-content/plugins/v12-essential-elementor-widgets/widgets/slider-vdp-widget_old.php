            ...
            <div id="ask-modal" class="ask-modal">
                <div class="ask-modal-content">
                    <div class="ask-modal-header">
                        <img width="100" src=<?php echo esc_url(plugins_url('/images/logo.svg', __FILE__)); ?>>
                        ...
                        <div id="ask-form-container" class="form-ask-side">
                            ...
                            <div class="agent-details">
                                <ul class="agent-information list-unstyled">
                                    <li class="agent-name"> Western Motors</li>
                                    <li class="agent-phone"> 
                                        <a href="tel:(209)%20362-3099">
                                          <span class="">(209) 362-3099</span>
                                        </a>
                                    </li>
                                    <li class="agent-address">
                                    <span class="elementor-icon-list-text"> 12912 Shelbyville Rd, <br>Louisville, KY 40243</span>
                                    </li>
                                </ul>
                            </div>
                            <form id="ask-question-form" class="fs-content lead-form">
                                ...
                                <input type="hidden" id="post_slug" value="<?php echo $post_slug; ?>">
                                    ...
                                    <div class="group">
                                        <input type="text" title="E-mail" placeholder=" " name="email" class="email form-input">
                                        <label>Email address</label><span class="input-error-req d-none">Email address required.</span>
                                    </div>
                                    <div class="group">
                                        <input type="Tel" title="Phone Number" id="phone" placeholder=" " name="phone" class="phone form-input">
