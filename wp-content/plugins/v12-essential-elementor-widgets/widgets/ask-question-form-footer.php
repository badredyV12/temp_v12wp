...
class Essential_Elementor_Ask_Form_Footer_Widget extends \Elementor\Widget_Base
{
...
// Replace 'secondary_color' with the actual setting name
    ...
    {
        return 'ask-form-footer';
    }

    public function get_title()
    {
        return esc_html__('ask Form Footer', 'essential-elementor-widget');
    }
    ...
    {
        return ['ask', "v12", "ask form footer"];
    }
        ...
        <div id="ask-form-container">
            ...
            <form id="ask-question-form-footer" class="fs-content lead-form">
                ...
                <div class="Cu-twice">
                    ...
                    <div class="group">
                        <input type="Tel" title="Phone Number" id="phone-ask-footer" placeholder=" " name="phone" class="phone form-input" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
